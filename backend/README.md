...
select * from f_verifier_schema()                → 0 ligne (67 garde-fous découverts, joués, consignés)
```

Schéma relevé **dans le catalogue**, pas dans le texte des migrations : **95 tables** en
**63 migrations**, **380 politiques**, **0 table sans RLS activée, 0 sans RLS forcée**,
...
composites** visant
`(id, filiale_id)`, **28 unicités** `uq_<parent>_id_filiale`, **67 contrôles consignés**
...
- **95 tables**, obtenues aujourd'hui en **63 migrations** appliquées de bout en bout par
