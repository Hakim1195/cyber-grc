...
| | |
|---|---|
| Révision mesurée | **`e83b083`** — la quantification financière (action 25.4), et le défaut que le NAVIGATEUR a trouvé après un banc vert : `sync.js` jetait tout ce que la réponse du serveur portait en plus de l'identifiant et de la version, 19/09/2026, relevée **sur la machine réelle** (Debian 13, `SRV-Infra`). ⚠️ **Ce bloc a déjà été RÉANCRÉ sept fois**, dont une où il désignait une révision cinquante-six commits en arrière (constat **Q-219**). Le garde-fou juge le document contre **la révision que le document nomme**, jamais contre l'arbre de travail. |
