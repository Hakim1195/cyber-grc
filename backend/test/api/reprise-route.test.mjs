...
describe('Le dernier chemin non éprouvé : un vieil export réel, de bout en bout', () => {
  test('un export v6 volumineux traverse VINGT-TROIS paliers ET atterrit en base', async () => {
    ...
    assert.equal(reponse.corps.rapport.version_cible, 29);
    assert.equal(reponse.corps.rapport.paliers.length, 23, 'v6 → v29, c’est vingt-trois paliers.');
