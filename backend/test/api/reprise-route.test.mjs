...
describe('Le dernier chemin non éprouvé : un vieil export réel, de bout en bout', () => {
  test('un export v6 volumineux traverse QUATORZE paliers ET atterrit en base', async () => {
    ...
    assert.equal(reponse.corps.rapport.version_cible, 20);
    assert.equal(reponse.corps.rapport.paliers.length, 14, 'v6 → v20, c’est quatorze paliers.');
