...
describe('Le dernier chemin non éprouvé : un vieil export réel, de bout en bout', () => {
  test('un export v6 volumineux traverse VINGT-DEUX paliers ET atterrit en base', async () => {
    ...
    assert.equal(reponse.corps.rapport.version_cible, 28);
    assert.equal(reponse.corps.rapport.paliers.length, 22, 'v6 → v28, c’est vingt-deux paliers.');
