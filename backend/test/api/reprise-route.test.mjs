...
describe('Le dernier chemin non éprouvé : un vieil export réel, de bout en bout', () => {
  test('un export v6 volumineux traverse QUINZE paliers ET atterrit en base', async () => {
    ...
    assert.equal(reponse.corps.rapport.version_cible, 23);
    assert.equal(reponse.corps.rapport.paliers.length, 17, 'v6 → v23, c’est dix-sept paliers.');
