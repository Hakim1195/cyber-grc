...
const SettingsModule = (() => {
    ...
    function render() {
        ...
        app.innerHTML = `
            <section class="page">
                <div class="dashboard-header">
                    <div>
                        <h1>⚙️ Paramètres & Sauvegardes</h1>
                ...
                <div class="dashboard-grid">
                    ...
                    <div class="dashboard-card" style="border-top: 4px solid var(--color-danger);">
                        ...
                        <p style="color: var(--text-muted); font-size: 0.9rem; margin-bottom: 20px;">
                            ...
                            <span style="color: var(--color-danger); font-weight: bold;">⚠️ Attention : Cette action effacera et remplacera DÉFINITIVEMENT toutes les données actuelles de ce navigateur.</span>
                        </p>
        ...
        confirmBtn.onclick = () => {
            ...
            if (!confirm("⚠️ Êtes-vous ABSOLUMENT SÛR de vouloir écraser toutes vos données actuelles avec ce fichier de sauvegarde ?")) {
                return;
            }
