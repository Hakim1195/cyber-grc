...
The search script lives inside this skill's own directory. The path below is relative to the repository root — run it from there, or prefix it with the repository root when the working directory is elsewhere:
