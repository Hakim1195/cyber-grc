...
| **L18.3** `--diagnostic` | ✅ livré — **quinze sujets** depuis L27, code 0/1/2, joué sur la recette. ⚠️ *Ce document a annoncé « douze » jusqu'au 11/09/2026 : le constat Q-290 avait porté le diagnostic de douze à quatorze sujets, et trois documents étaient restés en arrière. Un chiffre faux est un constat, pas une coquille* |
