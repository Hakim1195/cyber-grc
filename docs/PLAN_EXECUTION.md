...
| **Q-39** | La « référence » d'un incident vient du **client** : `requestIdHeader: 'x-request-id'`, non effacé par le vhost. Un utilisateur peut donc choisir la référence qu'un exploitant retrouvera dans les journaux | 🔵 mineur | agent **API** | avant le 8ᵉ passage | ouvert |
...
| **Q-41** | **Q-4, sixième signalement.** `README` §5 : « 564 essais », « quatre familles » | 🔵 mineur | agent **DOC** | avant le 8ᵉ passage | ouvert |
