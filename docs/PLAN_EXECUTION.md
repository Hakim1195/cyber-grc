...
| **Q-145** | **La documentation d'état livrée avec la vague 4 décrit l'état d'AVANT la vague 4** — « L4 → L15 ⬜ à faire ». **Dixième occurrence de la famille Q-4**, et la seconde fois que je la commets après l'avoir corrigée à S4 (Q-124) | 🟠 majeur | **orchestrateur** | **avant la porte S5 rejouée** | ouvert |
