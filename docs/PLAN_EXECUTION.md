...
| **Q-60** | Le garde-fou de Q-52 ignore les **59 `<script src>`** d'`index.html` : un script publié mais non commité passerait | 🔵 mineur | agent **OUTILLAGE** | avant le 10ᵉ passage | 🔧 en cours (OUTILLAGE) |
| **Q-61** | `decisives()` compare **46 des 99 directives** du vhost — l'essai éprouve donc en partie sa propre réécriture | 🔵 mineur | agent **OUTILLAGE** | avant le 10ᵉ passage | 🔧 en cours (OUTILLAGE) |
