...
| **Q-60** | Le garde-fou de Q-52 ignore les **59 `<script src>`** d'`index.html` : un script publié mais non commité passerait | 🔵 mineur | agent **OUTILLAGE** | avant le 10ᵉ passage | ouvert |
