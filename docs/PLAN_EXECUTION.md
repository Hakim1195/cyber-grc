...
| **Q-8** | Le différentiel complet est recalculé plusieurs fois par battement : sondage complet mesuré à 608 ms sur 12 000 enregistrements, et le correctif T-1 en a ajouté un, toutes les 20 s, y compris quand rien n'attend | 🔵 mineur | agent **FRONT** | **après** la fermeture de Q-3 — les tests de Q-3 exercent `sonder()`/`cycle()` | ouvert |
